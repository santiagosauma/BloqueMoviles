...
@Composable
fun EditarBorrarComentario(navController: NavController?, caseId: String, comentarioId:String) {
    ...
    if(isLoading)
    {
        ...
        PantallaComentarTemplate(
            ...
            onAddOrEditComment = { contenido, isUrgent, userId, comentario_id ->
                ...
                navController?.navigate("editarComentarioEstudiante/${caseId}/${comentarioId}")
            },
            bottomBarNav = {
                EstudiantesBarraNav(
                    navController = navController,
